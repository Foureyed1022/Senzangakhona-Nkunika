// PortfolioProjectsSection component has been commented out
// import { ExternalLink, FileText, Youtube } from "lucide-react"

// export function PortfolioProjectsSection() {
//   const projects: Array<{ name: string; type: string; description: string; resources: Array<{ label: string; icon: React.ComponentType<{ className?: string }>; link: string; color: string }> }> = [
//     // {
